...
A short intro to each project and a link out. To add one, copy a card block below
and edit the four parts: icon, title, description, link.
...
-   :material-file-document-arrow-right:{ .lg .middle } __doc2md__
    ...
    Convert documents into clean, agent-friendly Markdown.
...
-   :material-math-log:{ .lg .middle } __g3log__
    ...
    Asynchronous, crash-safe C++ logger. Battle-tested and widely used (900+ stars).
...
-   :material-rotate-360:{ .lg .middle } __lock-free-wait-free-circularfifo__
    ...
    A lock-free / wait-free circular FIFO — a classic concurrent data structure.
...
-   :material-chart-line:{ .lg .middle } __metrics-and-insights__
    ...
    Engineering-metrics analysis — turning team/process data into insight.
